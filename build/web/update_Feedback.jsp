...
<head>
    ...
    <style>
        ...
        .rating label {
            ...
            position: relative;
            width: 1.1em;
            font-size: 24px; /* Kích th??c c?a ngôi sao */
            color: #ccc; /* Màu m?c ??nh c?a ngôi sao */
            transition: color 0.2s; /* Hi?u ?ng chuy?n ??i màu */
            cursor: pointer;
        }

        .rating label:before {
            content: "\2605"; /* Kí hi?u ngôi sao (Unicode) */
        }

        .rating input:checked~label {
            color: #f90; /* Màu khi ng??i dùng ch?n */
        }

        /* Hi?u ?ng di chu?t qua */
        .rating label:hover,
        .rating label:hover~label {
            color: #f90; /* Màu khi di chu?t qua */
        }
    </style>
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="images/icons/favicon.png" />
