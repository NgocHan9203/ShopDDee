 ...
 * @author Han
 */
@WebServlet(name="CheckListCart", urlPatterns={"/CheckListCart"})
public class CheckListCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Gson gson = new Gson();
        List<ItemData> selectedItems = gson.fromJson(json, List.class);
