...
public class revenueServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int totalOrderCount = db.getTotalOrderCount();
        double totalSum = db.getTotalSum();
        int totalSoldProducts = db.getTotalSoldProducts();
        int canceledOrders = db.getCountOfCanceledOrders();
        Map<String, Double> monthlyRevenue = db.getMonthlyRevenue();
        List<Order> newOrderList= db.NewOrderList();
        List<Product> bestSeller= db.bestSeller();
        
        // Convert monthlyRevenue map to JSON string
        Gson gson = new Gson();
