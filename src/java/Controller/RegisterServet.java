 ...
 * @author manh
 */
@WebServlet(name="RegisterServet", urlPatterns={"/registerr"})
public class RegisterServet extends HttpServlet {
    ...
    try {
        ...
        if (customerDB.checkUserNameExist(get_userName) != null) {
            ...
            Customer customer = new Customer(get_userName, get_email, get_password, dob, get_address, gender, get_phone);
