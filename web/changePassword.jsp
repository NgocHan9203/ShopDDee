...
<body class="animsition">
    ...
    <div class="container-fluid">
        <form class="bg0 p-t-75 p-b-85" action="changepass" method="POST">
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                           type="password" placeholder="Enter new password" name="new">
                                </div>

                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                           type="password" placeholder="New password" name="confirm">
                                </div>
